...
**Comparison:** baseline_real vs no_gate_real

| Metric | baseline_real | no_gate_real |
|---|---|---|
...
**Comparison:** baseline_real vs no_oracle_real
...
**Comparison:** baseline_real vs naive_triage_real
...
| type2_count | 1 | 1 |
| non_bug_count | 0 | 0 |
| type2_share_among_illegal_failures | 100.00% | 100.00% |

## Table 5: Mock vs Real Comparison
**Comparison:** baseline_mock vs baseline_real

| Metric | baseline_mock | baseline_real |
|---|---|---|
| total_cases | 4 | 4 |
